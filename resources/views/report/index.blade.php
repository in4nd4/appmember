<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Report</x-page-title>

    <div class="bg-white rounded-4 shadow-sm p-4 mb-4">
        {{-- info form --}}
        <div class="alert alert-secondary rounded-4 mb-5" role="alert">
            <i class="ti ti-calendar-search fs-5 me-2"></i> Filter by join date.
        </div>
        {{-- form filter data --}}
            ...
            <div class="pt-4 pb-2 mt-5 border-top">
                <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                    ...
                    <button type="submit" class="btn btn-primary btn-action">
                        Show <i class="ti ti-chevron-right ms-2"></i>
                    </button>
                </div>
            </div>
        </form>
            ...
            <div class="d-flex flex-column flex-lg-row mb-4">
                <div class="flex-grow-1 d-flex align-items-center">
                    ...
                    <h6 class="mb-0">
                        ...
                        Members' data report on {{ date('F j, Y', strtotime(request('start_date'))) }} - {{ date('F j, Y', strtotime(request('end_date'))) }}.
                    </h6>
                </div>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped table-hover lh-lg" style="width:100%">
                    <thead>
                        ...
                        <th class="text-center fw-medium">Category</th>
                        <th class="text-center fw-medium">Join Date</th>
                        <th class="text-center fw-medium">Full Name</th>
                        <th class="text-center fw-medium">Gender</th>
                        <th class="text-center fw-medium">Address</th>
                        <th class="text-center fw-medium">Email</th>
                        <th class="text-center fw-medium">Phone</th>
                    </thead>
                    <tbody class="fs-7">
                    @php
                        $no = 1;
