...
<head>
    ...
    {{-- Title --}}
    <title>Members' Data Report on {{ date('F j, Y', strtotime(request('start_date'))) }} - {{ date('F j, Y', strtotime(request('end_date'))) }}</title>
...
<body>
    ...
    <div style="text-align: center">
        <h3>Members' Data Report on {{ date('F j, Y', strtotime(request('start_date'))) }} - {{ date('F j, Y', strtotime(request('end_date'))) }}.</h3>
    </div>
