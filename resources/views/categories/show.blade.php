<x-app-layout>
    {{-- Page Title --}}
    <x-page-title>Detail Category</x-page-title>
    ...
    <div class="bg-white rounded-4 shadow-sm p-4 mb-4">
        ...
        <div class="d-flex flex-column flex-xl-row">
            <div class="flex-shrink-0 mb-4 mb-xl-0">
                <img src="{{ asset('/storage/categories/'.$category->image) }}" class="img-thumbnail rounded-5 shadow-sm" width="100" alt="Image">
            </div>
            <div class="flex-grow-1 pt-2 ms-xl-4">
                <h6 class="text-muted fw-light mb-2">Name</h6>
                <p class="mb-4">{{ $category->name }}</p>
            
                <h6 class="text-muted fw-light mb-2">Description</h6>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mb-2">
                        Are you sure to delete <span class="fw-medium mb-2">{{ $category->name }}</span>?
                    </p>
                </div>
