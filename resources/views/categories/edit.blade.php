        ...
        <form action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-xl-4">
                    <div class="mb-3 ps-xl-3">
                        ...
                        <div class="mt-4 mt-xl-5">
                            <img id="imagePreview" src="{{ asset('/storage/categories/'.$category->image) }}" class="img-thumbnail rounded-5 shadow-sm" width="50%" alt="Image">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="pt-4 pb-2 mt-5 border-top">
                <div class="d-grid gap-3 d-sm-flex justify-content-md-start pt-1">
                    ...
                    <a href="{{ route('categories.show', $category->id) }}" class="btn btn-secondary btn-action">Cancel</a>
                </div>
            </div>
        </form>
    </div>
